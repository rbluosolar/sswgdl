...
Please address comments and suggestions to [Dr. Luo, RunBin (罗润彬)](mailto:rbluo@mail.ustc.edu.cn) or [Dr. Chen, Jun (陈俊)](mailto:chenjun@pmo.ac.cn)
...
* GDL: https://gnudatalanguage.github.io/downloads.html
  ...
  * If you download GDL from https://github.com/gnudatalanguage/gdl/releases
    * `$GDL_DIR` is where you unpack the package, it should contain `bin/gdl`
